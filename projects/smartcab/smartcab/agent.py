...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.025):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing is True:
            ...
            self.epsilon = 1./math.exp(float(self.alpha*self.num_trials))
            self.num_trials += 1
    ...
    def get_maxQ(self, state):
        ...
        return self.Q[self.state][maxQ_key]
    ...
    def choose_action(self, state):
        ...
        # agent is learning
            ...
            if rand <= 1.-self.epsilon:
                # get max Q value given state
                best_Q_val = self.get_maxQ(self.state)
                state_actions = self.Q[self.state]

                # initialize empty dict to store agent's best actions
                best_actions = dict()
